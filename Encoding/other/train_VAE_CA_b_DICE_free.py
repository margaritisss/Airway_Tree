...
from airway_project.Encoding.other.VAE_CA_b_DICE_free import VoxelVAE128, vae_loss, cyclical_beta
...
CFG_DEFAULTS = {
    ...
    "free_bits": 0.5,           # λ nats reserved per latent dim as a KL floor; 0.0 disables
