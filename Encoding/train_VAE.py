...
CFG_DEFAULTS = {
    ...
    "reg": 1e-3,                # original: cfg['reg'] = 0.001 (L2 weight decay)
    ...
    "num_latents": 256,         # our scale-up choice (paper used 100)
    "gamma": 0.98,              # weighted-BCE positive weight (released code)
...
def main():
    ...
    for epoch in range(start_epoch, cfg["max_epochs"]):
        ...
        # Periodic checkpoint (matches cfg['checkpoint_every_nth'])
